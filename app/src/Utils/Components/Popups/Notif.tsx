...
const Notif : FC<Props> = ({message, onClick, buttonTitle = "OK", style = "", buttonStyle = ""}) => {
    return (
        <section className={`${style} pointer-events-auto bottom-4 left-4 bg-neutral-100 dark:bg-neutral-950 text-black dark:text-white px-4 py-3 rounded-lg shadow-lg flex items-center animate-slide-up`}>
